package com.masamonoke.artgallery.api.profile.impl

import com.masamonoke.artgallery.api.profile.UserProfileService
...
@Service
class UserProfileService(val userRepo: UserRepo, val artistRepo: ArtistRepo): UserProfileService {
    override fun becomeArtist(username: String?, artistNickname: String): ResponseEntity<String> {
        if (username == null) {
